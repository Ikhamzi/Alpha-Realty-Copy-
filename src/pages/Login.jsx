...
const STYLES = `
  ...
  .auth-bg-glow {
    position: fixed; inset: 0; pointer-events: none; z-index: 0;
    background:
      radial-gradient(ellipse at 70% 20%, #ECE4FC66 0%, transparent 52%),
      radial-gradient(ellipse at 15% 80%, #D4EEF230 0%, transparent 48%);
  }
...
const Wolf = ({ size = 30 }) => (
    <svg width={size} height={size * 1.1} viewBox="0 0 100 110" fill="none" style={{ flexShrink: 0 }}>
        ...
        <polygon points="50,10 72,30 50,24" fill="url(#la)" />
        <polygon points="50,10 28,30 50,24" fill="url(#lb)" />
    ...
    <>
        ...
        <div className="auth-page">
            ...
            <div className="auth-card">
                ...
                {/* Heading */}
                <div className="auth-tag">Portal Access</div>
                <h1 className="auth-heading">Choose Your<br /><em>Login</em></h1>
                <p className="auth-sub">Select your role to access your dashboard</p>

                {/* Cards */}
                <Link to="/referral-login" className="path-card violet">
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
                        <div>
                            <div className="path-label violet">Referral</div>
                            <div className="path-title">Program Access</div>
                            <div className="path-desc">Submit and track leads</div>
                        </div>
                        <ArrowRight className="path-arrow violet" size={18} />
                    </div>
                </Link>

                <Link to="/partner-login" className="path-card teal">
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
                        <div>
                            <div className="path-label teal">Partner</div>
                            <div className="path-title">Channel Portal</div>
                            <div className="path-desc">Manage inventory &amp; leads</div>
                        </div>
