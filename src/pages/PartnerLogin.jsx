        ...
        <div className="min-h-screen bg-[#FAF7F2] flex items-center justify-center px-4 py-12">
            <div className="max-w-md w-full bg-white/90 backdrop-blur-xl rounded-[32px] shadow-[0_24px_64px_rgba(124,111,171,0.1)] p-10 space-y-8">
                <div className="text-center">
                    <div className="mx-auto w-24 h-24 bg-gradient-to-r from-[#1F7B7F] to-[#7C6FAB] rounded-2xl flex items-center justify-center mb-6">
                        <Award className="w-12 h-12 text-white" />
                    </div>
                    <h1 className="text-3xl font-semibold tracking-[-0.03em] text-[#1A1A2E] mb-2">Partner Login</h1>
                    <p className="text-[#5C5374] text-lg">Access your channel partner dashboard</p>
                </div>
                ...
                <div className="text-center">
                    <p className="text-[#5C5374]">
                        Referral member? <Link to="/referral-login" className="font-semibold text-[#7C6FAB] hover:text-[#1A1A2E]">Referral Login</Link>
                    </p>
                </div>
            </div>
        </div>
